...
GSUI.setTemplate( "gsui-effects-fx", () => (
	GSUI.createElement( "div", { class: "gsuiEffects-fx", draggable: "true" },
		GSUI.createElement( "div", { class: "gsuiEffects-fx-head" },
			...
			GSUI.createElement( "button", { class: "gsuiEffects-fx-toggle gsuiIcon", "data-icon": "toggle", title: "Переключить эффект" } ),
			GSUI.createElement( "span", { class: "gsuiEffects-fx-name" } ),
			GSUI.createElement( "button", { class: "gsuiEffects-fx-remove gsuiIcon", "data-icon": "close", title: "Удалить эффект" } ),
		),
