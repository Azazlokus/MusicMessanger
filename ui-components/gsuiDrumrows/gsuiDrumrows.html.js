...
GSUI.setTemplate( "gsui-drumrow", () => (
	GSUI.createElement( "form", { class: "gsuiDrumrow", draggable: "true" },
		...
		GSUI.createElement( "div", { class: "gsuiDrumrow-main" },
			GSUI.createElement( "button", { type: "button", class: "gsuiIcon gsuiDrumrow-btnToggle", "data-action": "toggle", "data-icon": "toggle", title: "Переключить ударные" } ),
			GSUI.createElement( "button", { type: "button", class: "gsuiIcon gsuiDrumrow-btnProps", "data-action": "props", "data-icon": "drumprops", title: "Расширить панель" } ),
			GSUI.createElement( "button", { type: "button", class: "gsuiIcon gsuiDrumrow-btnDelete", "data-action": "delete", "data-icon": "close", title: "Удалить ряд ударных" } ),
